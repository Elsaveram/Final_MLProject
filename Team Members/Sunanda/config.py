HOUSE_CONFIG = {
	...
	"Utilities": {
		...
		"imputation_method": "",
		"members": {
			"AllPub": { "ordinal":1, "name":"All public Utilities (E,G,W,& S)	"},
			"NoSewr": { "ordinal":2, "name":"Electricity, Gas, and Water (Septic Tank)"},
			"NoSeWa": { "ordinal":3, "name":"Electricity and Gas Only"},
			"ELO": { "ordinal":4, "name":"Electricity only	"},
		}
	},
	"LotConfig": {
	...
	"OverallCond": {
		...
		"imputation_method": "",
		"members": {
			"10": { "ordinal":1, "name":"Very Excellent"},
			"9": { "ordinal":2, "name":"Excellent"},
			"8": { "ordinal":3, "name":"Very Good"},
			"7": { "ordinal":4, "name":"Good"},
			"6": { "ordinal":5, "name":"Above Average	"},
			"5": { "ordinal":6, "name":"Average"},
			"4": { "ordinal":7, "name":"Below Average	"},
			"3": { "ordinal":8, "name":"Fair"},
			"2": { "ordinal":9, "name":"Poor"},
			"1": { "ordinal":10, "name":"Very Poor"},
		}
	},
	"YearBuilt": {
	...
	"BsmtQual": {
		...
		"imputation_method": "",
		"members": {
			"Ex": { "ordinal":1, "name":"Excellent (100+ inches)	"},
			"Gd": { "ordinal":2, "name":"Good (90-99 inches)"},
			"TA": { "ordinal":3, "name":"Typical (80-89 inches)"},
			"Fa": { "ordinal":4, "name":"Fair (70-79 inches)"},
			"Po": { "ordinal":5, "name":"Poor (<70 inches"},
			"NA": { "ordinal":6, "name":"No Basement"},
		}
	},
	"BsmtCond": {
		...
		"members": {
			"Ex": { "ordinal":1, "name":"Excellent"},
			"Gd": { "ordinal":2, "name":"Good"},
			"TA": { "ordinal":3, "name":"Typical - slight dampness allowed"},
			"Fa": { "ordinal":4, "name":"Fair - dampness or some cracking or settling"},
			"Po": { "ordinal":5, "name":"Poor - Severe cracking, settling, or wetness"},
			"NA": { "ordinal":6, "name":"No Basement"},
			"None": { "ordinal":6, "name":"No Basement"},
		}
	},
	"BsmtExposure": {
		...
		"imputation_method": "",
		"members": {
			"Gd": { "ordinal":1, "name":"Good Exposure"},
			"Av": { "ordinal":2, "name":"Average Exposure (split levels or foyers typically score average or above)	"},
			"Mn": { "ordinal":3, "name":"Mimimum Exposure"},
			"No": { "ordinal":4, "name":"No Exposure"},
			"NA": { "ordinal":5, "name":"No Basement"},
			"None": { "ordinal":5, "name":"No Basement"},
		}
	},
	"BsmtFinType1": {
	...
	"FireplaceQu": {
		...
		"imputation_method": "",
		"members": {
			"Ex": { "ordinal":1, "name":"Excellent - Exceptional Masonry Fireplace"},
			"Gd": { "ordinal":2, "name":"Good - Masonry Fireplace in main level"},
			"TA": { "ordinal":3, "name":"Average - Prefabricated Fireplace in main living area or Masonry Fireplace in basement"},
			"Fa": { "ordinal":4, "name":"Fair - Prefabricated Fireplace in basement"},
			"Po": { "ordinal":5, "name":"Poor - Ben Franklin Stove"},
			"NA": { "ordinal":6, "name":"No Fireplace"},
			"None": { "ordinal":6, "name":"No Fireplace"},
		}
	},
	"GarageType": {
